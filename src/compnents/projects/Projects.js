  ...
  return (
    <div className='container mx-auto px-4'>
      ...
      <div className='grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 mt-5 gap-y-10'>
        <div className="card lg:w-96 md:w-80 sm:w-auto bg-sky-700 shadow-xl">
        ...
        </div><div className="card lg:w-96 md:w-80 sm:w-auto  bg-sky-700 shadow-xl">
          <figure><img src="https://placeimg.com/400/225/arch" alt="Shoes" /></figure>
          <div className="card-body">
          ...
          <div className="card-body">
            ...
            <div className="card-actions justify-between">
              <button className="btn btn-outline font flex items-center gap-x-1"><FaLink />Live site</button>
              <button className="btn btn-outline font felx items-center gap-x-1"><FaGithub />Git</button>
            </div>
          </div>
        </div>
      </div>
